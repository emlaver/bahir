...
print ('About to test org.apache.bahir.cloudant for n_customer with setting schemaSampleSize to 1')
spark.sql(" CREATE TEMPORARY TABLE customerTable USING org.apache.bahir.cloudant OPTIONS ( database 'n_customer', schemaSampleSize '1')")
verify()
