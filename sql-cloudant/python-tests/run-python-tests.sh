...
# run the tests in a virtual enviornment that includes the required dependencies
# Note: spark-submit is called in test_base.py
...
export CLOUDANT_ACCOUNT=\$CLOUDANT_USER
