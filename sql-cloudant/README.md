...
--- |:---:| ---
cloudant.batchInterval|10| number of seconds for batch to hold data before creating RDD.  See [Spark Guide: Setting the Right Batch Interval](https://spark.apache.org/docs/latest/streaming-programming-guide.html#setting-the-right-batch-interval) for tuning this option.
